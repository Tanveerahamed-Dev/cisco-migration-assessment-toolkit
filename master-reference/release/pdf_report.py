...
def _validated_capabilities_impl(
    ...
    if len(entries) != 212:
        raise _PdfCapabilityInputError("PDF capability catalog must contain exactly 212 entries")
...
def _validate_capability_observation_envelope(
    ...
    try:
        ...
        for field, row_fields, expected_count in (
            ("rendered_observations", _CAPABILITY_RENDERED_OBSERVATION_FIELDS, 424),

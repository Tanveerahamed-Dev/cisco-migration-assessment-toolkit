...
def test_docx_pptx_deliverables_tolerate_malformed_numeric_leaves(tmp_path):
    ...
    deck.write_executive_deck_pptx(str(tmp_path / "k.pptx"), snap, "Meridian")
    design.write_design_doc_docx(str(tmp_path / "d.docx"), snap, "Meridian")
    mop.write_mop_docx(str(tmp_path / "m.docx"), snap, "Meridian")
    ops.write_ops_handbook_docx(str(tmp_path / "o.docx"), snap, "Meridian")
    runbook.write_runbook_docx(str(tmp_path / "r.docx"), snap, "Meridian")
    crd.write_crd_docx(str(tmp_path / "c.docx"), snap, "Meridian")
    engagement.write_engagement_docx(str(tmp_path / "e.docx"), snap, "Meridian")
    archreview.write_archreview_docx(str(tmp_path / "a.docx"), snap, "Meridian")

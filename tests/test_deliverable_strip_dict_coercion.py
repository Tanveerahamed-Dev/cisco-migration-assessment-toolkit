...
def test_deliverable_generators_tolerate_dict_valued_device_string_fields(tmp_path):
    ...
    crd.write_crd_docx(str(tmp_path / "c.docx"), _HOSTILE, "[HISTORY-REDACTED]")
    design.write_design_doc_docx(str(tmp_path / "d.docx"), _HOSTILE, "[HISTORY-REDACTED]")
    mop.write_mop_docx(str(tmp_path / "m.docx"), _HOSTILE, "[HISTORY-REDACTED]")
    runbook.write_runbook_docx(str(tmp_path / "r.docx"), _HOSTILE, "[HISTORY-REDACTED]")

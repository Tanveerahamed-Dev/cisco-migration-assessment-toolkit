...
def test_classify_apc_real_registry_name_chained():
    ...
    APC UPS endpoints fell through unclassified (342 rows / 311 Unknown on the AJ snapshot). The existing fixture
...
def test_classify_resolved_vendor_evidence_never_says_no_vendor():
    ...
    genuinely empty. (On the AJ snapshot the false string hit 1770/5127 rows, true in 0.)"""
    from cisco_toolkit.analyze import _classify_endpoint

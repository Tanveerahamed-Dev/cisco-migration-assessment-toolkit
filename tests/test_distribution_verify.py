...
def test_transition_runtime_data_assets_are_explicit_package_data_and_required() -> None:
    assets = {
        ...
        "data/atlas-r2-dsl-prototype-denominator.v1.json",
        "data/atlas-r2-dsl-prototype-input.v1.json",
        "data/atlas-r2-dsl-prototype-pack.experimental.json",
        "data/atlas-r2-dsl-prototype-program.v1.json",
        "data/atlas-r2-dsl-prototype-tcb.v2.json",
        "data/atlas-r2-dsl-prototype-measurements.v1.json",
        "data/atlas-r2-runtime-inventory.reference.v1.json",

...
| 3 | **Software-currency + health debt** | **~72% EoL/replace-grade; 67% Critical/Poor health; only 3.6% current** | Chronic — support + exposure risk | ◑ A phased refresh **program**; needs PSIRT fixed-versions + refresh budget |

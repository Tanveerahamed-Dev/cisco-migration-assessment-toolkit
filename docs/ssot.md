...
| **Release version** | `pyproject.toml :: version` (currently 3.30.0) — bump at **tag time only** | — | ✅ this cached value reconciled to the owner by `tests/test_registry_freshness.py` |

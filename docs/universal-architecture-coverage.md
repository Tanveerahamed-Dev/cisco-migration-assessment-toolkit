...
TENTATIVE, OSPFv3 2WAY-DROTHER, a lone LISP Down peer). Proven on the canonical [HISTORY-REDACTED] customer snapshot: all 29
detectors fire on synthetic fixtures yet produce **zero** decisions on the real [HISTORY-REDACTED] fleet (which captured none

...
# surfaces this as a 'Media / timing fabric' TARGET-STATE DIMENSION (not a firing decision). Relevant to the AJ
# (Al Jazeera) broadcast estate; cited as a dimension driver. Web-verified (SMPTE ST 2059-2 / ST 2110-10).
...
# fire on collected (non-AJ) architecture state but PREVIOUSLY had no backing principle, so a fired

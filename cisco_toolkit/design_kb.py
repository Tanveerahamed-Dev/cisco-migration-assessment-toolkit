...
# on the (S,G) case (the benign (*,G) case is excluded -- proven on the [HISTORY-REDACTED] fleet's 36 (*,G)-Null entries).
_MULTICAST_RPF_ADDENDUM = [
    {
        ...
        "shows a Null IIF for locally-joined / well-known / SSM groups (36 such benign entries on the [HISTORY-REDACTED] fleet) "
...
# fire on collected (non-[HISTORY-REDACTED]) architecture state but PREVIOUSLY had no backing principle, so a fired
